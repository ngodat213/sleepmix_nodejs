...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#0F0A1F] to-[#1A1528]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            <Link 
              href="/" 
              className="text-2xl font-medium bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent hover:from-[#6C5DD3] hover:to-[#8677E5] transition-all duration-300"
            >
              Hydra Teams
            </Link>
          ...
          <div className="flex flex-col lg:items-end">
            <div className="space-y-4">
              ...
              >
                <svg className="w-5 h-5 text-[#6C5DD3] group-hover:text-[#8677E5] transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-[#6C5DD3] group-hover:text-[#8677E5] transition-all duration-300">
                  +84 399 228 357
                </span>
              </a>
              <a
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            <p className="text-gray-400">
              © {new Date().getFullYear()} Hydra Teams. All rights reserved.
            </p>
